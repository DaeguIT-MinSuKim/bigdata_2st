...
public class HairMain extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					 ...
					 * GraphiteLookAndFeel.setCurrentTheme(props);//팝업 메뉴 등장하는
					 * jtattoo 로고 변환 UIManager.setLookAndFeel(
	...
	public HairMain() {
		...
		contentPane.setBackground(new Color(177, 70, 194));
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(new BorderLayout(0, 0));

		tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setFont(new Font("맑은 고딕", Font.PLAIN, 25));
		tabbedPane.setForeground(new Color(177, 70, 194));
		tabbedPane.setBackground(new Color(0, 255, 255));
		contentPane.add(tabbedPane, BorderLayout.CENTER);
		bdr = new EmptyBorder(5,3,5,3); 
		pnHome = new JPanel();
		pnHome.setBackground(new Color(0, 255, 255));
		...
		pnHomeMain.setBackground(new Color(0, 255, 255));
		pnHome.add(pnHomeMain, BorderLayout.CENTER);

		pnCusSearch = new JPanel();
		pnCusSearch.setBackground(new Color(0, 255, 255));
		...
		pnCusSearchCards.setBackground(new Color(0, 255, 255));
		...
		pnSearchSub.setBackground(new Color(0, 255, 255));
		...
		pnCusAdd.setBackground(new Color(0, 255, 255));
		...
		pnCusSearchBtns.setBorder(new EmptyBorder(10, 10, 10, 10));
		pnCusSearchBtns.setBackground(new Color(0, 255, 255));
		pnCusSearch.add(pnCusSearchBtns, BorderLayout.EAST);
		pnCusSearchBtns.setLayout(new GridLayout(2, 2, 10, 10));
		...
		btnSearch.setBackground(new Color(177, 70, 194));
		pnCusSearchBtns.add(btnSearch);

		btnAdd = new JButton("회원추가");
		btnAdd.setForeground(new Color(0, 255, 255));
		btnAdd.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				btnAddActionPerformed(e);
			}
		});
		btnAdd.setBackground(new Color(177, 70, 194));
		pnCusSearchBtns.add(btnAdd);

		btnSave = new JButton("저장");
		btnSave.setForeground(new Color(0, 255, 255));
		btnSave.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		...
		btnSave.setBackground(new Color(177, 70, 194));
		pnCusSearchBtns.add(btnSave);

		btnToMain1 = new JButton("메인화면");
		btnToMain1.setForeground(new Color(0, 255, 255));
		btnToMain1.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		btnToMain1.setBackground(new Color(177, 70, 194));
		...
		pnHairOder.setBackground(new Color(0, 255, 255));
		...
		pnHairOderMain.setBackground(new Color(0, 255, 255));
		pnHairOder.add(pnHairOderMain, BorderLayout.CENTER);

		pnHairOderBtns = new JPanel();
		pnHairOderBtns.setBorder(new EmptyBorder(10, 10, 10, 10));
		pnHairOderBtns.setBackground(new Color(0, 255, 255));
		pnHairOder.add(pnHairOderBtns, BorderLayout.EAST);
		pnHairOderBtns.setLayout(new GridLayout(2, 2, 10, 10));

		btnOrder = new JButton("주문");
		btnOrder.setForeground(new Color(0, 255, 255));
		...
		btnOrder.setBackground(new Color(177, 70, 194));
		pnHairOderBtns.add(btnOrder);

		btnHairInfo = new JButton("헤어정보");
		btnHairInfo.setForeground(new Color(0, 255, 255));
		btnHairInfo.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		...
		btnHairInfo.setBackground(new Color(177, 70, 194));
		pnHairOderBtns.add(btnHairInfo);

		btnToMain2 = new JButton("메인화면");
		btnToMain2.setForeground(new Color(0, 255, 255));
		btnToMain2.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		btnToMain2.setBackground(new Color(177, 70, 194));
		...
		pnOrderList.setBackground(new Color(0, 255, 255));
		pnOrderListMain = new HairOrderSearch();
		pnOrderListMain.setBackground(new Color(0, 255, 255));
		...
		pnOrderListBtns.setBorder(new EmptyBorder(10, 10, 10, 10));
		pnOrderListBtns.setBackground(new Color(0, 255, 255));
		pnOrderList.add(pnOrderListBtns, BorderLayout.EAST);
		pnOrderListBtns.setLayout(new GridLayout(2, 2, 10, 10));

		btnToMain3 = new JButton("메인화면");
		btnToMain3.setForeground(new Color(0, 255, 255));
		btnToMain3.setFont(new Font("맑은 고딕", Font.BOLD, 25));
		btnToMain3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				btnToMainActionPerformed(e);
			}
		});
		btnToMain3.setBackground(new Color(177, 70, 194));
		pnOrderListBtns.add(btnToMain3);

		label = new JLabel("");
		pnOrderListBtns.add(label);

		label_1 = new JLabel("");
		pnOrderListBtns.add(label_1);

		label_2 = new JLabel("");
		pnOrderListBtns.add(label_2);
		...
		pnBizListMain.setBackground(new Color(0, 255, 255));
		...
		pnBizGraphMain.setBackground(new Color(0, 255, 255));
	...
	private void setAllBorder() {
		...
		pnHome.setBorder(bdr);
		pnCusSearch.setBorder(bdr);
		pnHairOder.setBorder(bdr);
		pnOrderList.setBorder(bdr);
		pnBizList.setBorder(bdr);
		pnBizGraph.setBorder(bdr);
		tabbedPane.setBorder(bdr);
		pnHomeMain.setBorder(bdr);
		pnCusSearchCards.setBorder(bdr);
		pnCusSearchBtns.setBorder(bdr);
		btnAdd.setBorder(bdr);
		btnToMain1.setBorder(bdr);
		pnHairOderMain.setBorder(bdr);
		pnHairOderBtns.setBorder(bdr);
		btnOrder.setBorder(bdr);
		btnToMain2.setBorder(bdr);
		pnOrderListMain.setBorder(bdr);
		pnOrderListBtns.setBorder(bdr);
		btnToMain3.setBorder(bdr);
		pnBizListMain.setBorder(bdr);
		pnBizGraphMain.setBorder(bdr);
		btnSave.setBorder(bdr);
		btnHairInfo.setBorder(bdr);
		pnSearchSub.setBorder(bdr);
		pnCusAdd.setBorder(bdr);
		pnCusEdit.setBorder(bdr);
		btnSearch.setBorder(bdr);
		tableInSearch.setBorder(bdr);
		tableInSearchForAll.setBorder(bdr);
		hip.setBorder(bdr);
		panel_1.setBorder(bdr);
		panel.setBorder(bdr);
	...
	protected void btnAddActionPerformed(ActionEvent e) {
		...
		List<Customer> customerForSize = CustomerService.getInstance().selectByAll();// 카운트
																						// 할
																						// sql문을
																						// 만드는
																						// 게
	...
	protected void btnSaveActionPerformed(ActionEvent e) {
		...
		case 1:
			...
			if (directOderInAdd == 0) {
				pnHairOderMain.setTxtInOrder(Integer.parseInt(pnCusAdd.getTxtCno().getText()),
						pnCusAdd.getTxtCname().getText());
		...
		case 2:
			...
			if (directOderInEdit == 0) {
				pnHairOderMain.setTxtInOrder(Integer.parseInt(pnCusEdit.getTxtCno().getText()),
						pnCusEdit.getTxtCname().getText());
				tabbedPane.setSelectedComponent(pnHairOder);
				// tabbedPane.setEnabledAt(2, true);
			}
			cardIndex = 0;
	...
	private void clickAndGetDataFromTable(JTable table) {
		...
		cNo = Integer.parseInt(table.getValueAt(table.getSelectedRow(), 0).toString()); // 선택한
																						// 열의
																						// 0번째
																						// 인덱스
																						// 행을
		...
		if (e.isPopupTrigger() && e.getComponent() instanceof JTable) {
			...
			popup.add(new JMenuItem(new AbstractAction("수정") {
				public void actionPerformed(ActionEvent e) {
					...
					btnSave.setEnabled(true);
					cardIndex = 2;
					pnHairOderMain.setTxtInOrder(cNo, cName); // 수정된 내역이 있더라도
																// DB와 관련된것은 변동이
																// 없는 cNo뿐이라
																// 무관함.
